...
class VCRDistortionShader extends FlxShader // https://www.shadertoy.com/view/ldjGzV and https://www.shadertoy.com/view/Ms23DR and https://www.shadertoy.com/view/MsXGD4 and https://www.shadertoy.com/view/Xtccz4
{
  ...
  @:glFragmentSource('
    ...
    void main()
    {
      ...
      video.r += 0.04*getVideo(0.75*vec2(x+0.004, -0.04)+vec2(uv.x+0.001,uv.y+0.001)).x;
      video.g += 0.03*getVideo(0.75*vec2(x+-0.004, -0.04)+vec2(uv.x+0.000,uv.y-0.002)).y;
      video.b += 0.04*getVideo(0.75*vec2(x+-0.03, -0.03)+vec2(uv.x-0.002,uv.y+0.000)).z;
