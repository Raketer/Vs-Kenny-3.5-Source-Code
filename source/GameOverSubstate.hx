...
class GameOverSubstate extends MusicBeatSubstate
{
	...
	public static function resetVariables() {
		...
		if (PlayState.SONG.song.toLowerCase() == 'burger')
		{
			characterName = 'bf-sun';
			deathSoundName = 'fnf_loss_sfx';
			loopSoundName = 'gameOver';
			endSoundName = 'gameOverEnd';
		}

		if (PlayState.SONG.song.toLowerCase() == 'pizza')
		{
			characterName = 'bf-techo';
			deathSoundName = 'fnf_loss_sfx';
			loopSoundName = 'gameOver';
			endSoundName = 'gameOverEnd';
		}

		if (PlayState.SONG.song.toLowerCase() == 'pizza-old')
		{
			characterName = 'bf-techo';
			deathSoundName = 'fnf_loss_sfx';
			loopSoundName = 'gameOver';
		...
		if (PlayState.SONG.song.toLowerCase() == 'southpurgation')
		{
			characterName = 'bf-night';
			deathSoundName = 'fnf_loss_sfx';
			loopSoundName = 'gameOver';
			endSoundName = 'gameOverEnd';
		}

		if (PlayState.SONG.song.toLowerCase() == 'triple-park')
		{
