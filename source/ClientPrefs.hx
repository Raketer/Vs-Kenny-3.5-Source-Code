...
class ClientPrefs {
	...
	public static var rain:Bool = true;
	...
	public static var noteSpaches:Bool = true;
	...
	public static function saveSettings() {
		...
		FlxG.save.data.rain = rain;
		FlxG.save.data.fog = fog;
		...
		FlxG.save.data.noteSpaches = noteSpaches;
	...
	public static function loadPrefs() {
		...
		if(FlxG.save.data.rain != null) {
			rain = FlxG.save.data.rain;
		}

		if(FlxG.save.data.fog != null) {
			fog = FlxG.save.data.fog;
		}
		...
		if(FlxG.save.data.noteSpaches != null) {
			noteSpaches = FlxG.save.data.noteSpaches;
		}
